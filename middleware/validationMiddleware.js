...
import { PROPERTY_TYPE, PROPERTY_STATUS } from "../utils/constant.js";
...
export const validatePropertyInput = withValidationErrors([
...
export const validateIdParam = withValidationErrors([
  param("id").custom(async (value, { req }) => {
    ...
    const isOwner = req.user.userId === property.createdBy.toString();
